...
1. **Download and Run BAPD:**
   ...
   * The BAPD tool will create a directory named "BAPD" in your user directory (e.g., `C:\Users\<your_username>\BAPD` on Windows).
...
5. **Launch BAPD:**
   * Run the BAPD executable file again. The tool should now be ready to use.
