...
class Ui_projectSelectionDialog(object):
    def setupUi(self, projectSelectionDialog):
        ...
        self.createNewProjectRadioButton = QRadioButton(self.newProjectGroupBox)
        self.createNewProjectRadioButton.setObjectName(u"createNewProjectRadioButton")
        self.createNewProjectRadioButton.setGeometry(QRect(10, 30, 161, 20))
        self.createNewProjectRadioButton.setFont(font)
    ...
    def retranslateUi(self, projectSelectionDialog):
        ...
        self.createNewProjectRadioButton.setText(QCoreApplication.translate("projectSelectionDialog", u"Create New Project", None))
